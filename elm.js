	...
	function (items, model) {
		var table = {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$UI$backButton(_user$project$Msgs$GotoProject),
					_1: {
						ctor: '::',
