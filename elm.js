...
var _user$project$Msgs$AllProjects = function (a) {
	return {ctor: 'AllProjects', _0: a};
};
...
var _user$project$Msgs$AddProject = function (a) {
...
var _user$project$Main$decodeProjects = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
...
var _user$project$Main$getProjects = function () {
	var url = 'http://localhost:4000/api/projects';
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Msgs$AllProjects,
		A2(_elm_lang$http$Http$get, url, _user$project$Main$decodeProjects));
}();
var _user$project$Main$delete = function (name) {
	return _elm_lang$http$Http$request(
		{
			method: 'DELETE',
			headers: {ctor: '[]'},
			url: A2(_elm_lang$core$String$append, 'http://localhost:4000/api/projects?name=', name),
			body: _elm_lang$http$Http$emptyBody,
			expect: _elm_lang$http$Http$expectString,
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: false
...
var _user$project$Main$deleteProject = function (projectName) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Msgs$DeleteProject,
		_user$project$Main$delete(projectName));
};
var _user$project$Main$addProject = function (name) {
	var url = A2(_elm_lang$core$String$append, 'http://localhost:4000/api/projects?name=', name);
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Msgs$AddProject,
		A3(
...
var _user$project$Main$renderProject = function (name) {
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Msgs$ExpandProject(name)),
				_1: {ctor: '[]'}
			}
		},
		{
				...
				_0: A2(
					_elm_lang$html$Html$i,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Msgs$RemoveProject(name)),
							_1: {ctor: '[]'}
						}
					},
					{
...
var _user$project$Main$renderProjects = function (projects) {
	var projectItems = A2(_elm_lang$core$List$map, _user$project$Main$renderProject, projects);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Main$renderProjects(model.projects),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
										...
										},
										{
											...
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _user$project$Main$onKeyDown(_user$project$Msgs$KeyDown),
														_1: {
															ctor: '::',
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
				...
				if (_elm_lang$core$Native_Utils.eq(_p0._0, 13)) {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{newProjectName: ''}),
						_1: _user$project$Main$addProject(projectName)
					};
				} else {
			...
			case 'GetProjects':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$getProjects};
			case 'AddProject':
				if (_p0._0.ctor === 'Ok') {
					return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$getProjects};
				} else {
			...
			case 'RemoveProject':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$deleteProject(_p0._0)
				};
			case 'DeleteProject':
				if (_p0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								projects: A2(
									...
									function (project) {
										return !_elm_lang$core$Native_Utils.eq(project, _p0._0._0);
									},
									model.projects)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$Main$init = {
	...
	_0: A2(
		...
		{ctor: '[]'},
		''),
	_1: _user$project$Main$getProjects
};
